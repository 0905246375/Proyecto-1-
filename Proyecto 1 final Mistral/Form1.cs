...
namespace Proyecto_1_final_Mistral
{
    public partial class Form1 : Form
    {
...

        {
            ...
            string apiKey = ""; //  API Key de OpenRouter
            string url = ""; // Conexion con la API 

            var httpClient = new HttpClient();
            httpClient.DefaultRequestHeaders.Add("Authorization", $"Bearer {apiKey}");
            httpClient.DefaultRequestHeaders.Add("HTTP-Referer", "https://tupagina.com"); 
            httpClient.DefaultRequestHeaders.Add("X-Title", "MiAppIA"); 
        ...
        private void GenerarDocumentoWord()
        {
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                if (reader.Read())
                {
                    ...
                    string ruta = Path.Combine(carpeta, "ReporteIA.docx"); 
